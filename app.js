...
function initCatalog() {
  ...
  [[dune,14,'dune'],[dexter,96,'dexter'],[walkingDead,177,'walking-dead'],[sandman,21,'sandman'],[witcher,40,'witcher'],[strangerThings,42,'stranger-things'],[gameOfThrones,73,'game-of-thrones'],[breakingBad,62,'breaking-bad'],[blackMirror,33,'black-mirror'],[friends,236,'friends'],[lastOfUs,16,'last-of-us'],[dark,26,'dark'],[wandavision,9,'wandavision'],[squidGame,22,'squid-game'],[sexEducation,32,'sex-education']].forEach(([series,total,id])=>{const value=Math.round(series.watched.length/total*100);document.getElementById(`${id}-catalog-progress-label`).textContent=`${value}% assistido`;setWidth(`${id}-catalog-progress`,value)});
}
