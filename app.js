...
const LOVE_IS_BLIND_FRANCE_STORAGE_KEY = 'series-loner-love-is-blind-france-v1';
const ARROW_STORAGE_KEY = 'series-loner-arrow-v1';
const AGENTS_SHIELD_STORAGE_KEY = 'series-loner-marvels-agents-of-shield-v1';
const AGENT_CARTER_STORAGE_KEY = 'series-loner-marvels-agent-carter-v1';
const SUPERGIRL_STORAGE_KEY = 'series-loner-supergirl-v1';
const LEGENDS_TOMORROW_STORAGE_KEY = 'series-loner-dcs-legends-of-tomorrow-v1';
...
const PROFILE_LIBRARY = [
  ...
  ['better-call-saul',BETTER_CALL_SAUL_STORAGE_KEY,63,'better-call-saul'],['mr-robot',MR_ROBOT_STORAGE_KEY,45,'mr-robot'],['marvels-jessica-jones',JESSICA_JONES_STORAGE_KEY,39,'marvels-jessica-jones'],['marvels-luke-cage',LUKE_CAGE_STORAGE_KEY,26,'marvels-luke-cage'],['marvels-iron-fist',IRON_FIST_STORAGE_KEY,23,'marvels-iron-fist'],['ransom-canyon',RANSOM_CANYON_STORAGE_KEY,18,'ransom-canyon'],['love-is-blind-france',LOVE_IS_BLIND_FRANCE_STORAGE_KEY,10,'love-is-blind-france'],
  ['arrow',ARROW_STORAGE_KEY,170,'arrow'],['marvels-agents-of-shield',AGENTS_SHIELD_STORAGE_KEY,136,'marvels-agents-of-shield'],['marvels-agent-carter',AGENT_CARTER_STORAGE_KEY,18,'marvels-agent-carter'],['supergirl',SUPERGIRL_STORAGE_KEY,126,'supergirl'],['dcs-legends-of-tomorrow',LEGENDS_TOMORROW_STORAGE_KEY,110,'dcs-legends-of-tomorrow']
];
const seasons = {
...
import('./auth-shell.js?v=notifications-1');
