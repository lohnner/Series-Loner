...
const hotdAuthEntry=document.querySelector('.header-xp');if(hotdAuthEntry)hotdAuthEntry.insertAdjacentHTML('beforebegin','<a class="auth-link" href="#entrar">ENTRAR</a>');initHotd();let hotdReleaseDay=hotdBrazilToday();setInterval(()=>{const day=hotdBrazilToday();if(day!==hotdReleaseDay)location.reload()},60000);import('../../auth-shell.js?v=notifications-1');
