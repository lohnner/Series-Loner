...
const hotdAuthEntry=document.querySelector('.header-xp');if(hotdAuthEntry)hotdAuthEntry.insertAdjacentHTML('beforebegin','<a class="auth-link" href="../../login.html">ENTRAR</a>');initHotd();
